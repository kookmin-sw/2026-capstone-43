...
class C_PiperRosNode():
    ...
    def PublishArmJointAndGripper(self):
        ...
        joint_6_visual = joint_6 * 0.5
        self.joint_states.position = [joint_0,joint_1, joint_2, joint_3, joint_4, joint_5, joint_6_visual]
    ...
    def pos_callback(self, pos_data):
        ...
        if not self.block_ctrl_flag:
            ...
            if(self.GetEnableFlag()):
                ...
                if(pos_data.gripper>87000): gripper = 87000
    ...
    def joint_callback(self, joint_data):
        ...
        if not self.block_ctrl_flag:
            ...
            if(len(joint_data.position) >= 7):
                ...
                joint_6 = joint_6 * 2
                if(joint_6>87000): joint_6 = 87000
